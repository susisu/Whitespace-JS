...
class Mark extends FlowControl {
    ...
    toSubWhitespace() {
        return utils.SPACE + utils.SPACE + utils.intToWhitespace(this.label);
    }
...
class Call extends FlowControl {
    ...
    toSubWhitespace() {
        return utils.SPACE + utils.TAB + utils.intToWhitespace(this.label);
    }
...
class Jump extends FlowControl {
    ...
    toSubWhitespace() {
        return utils.SPACE + utils.LF + utils.intToWhitespace(this.label);
    }
...
class IfZero extends FlowControl {
    ...
    toSubWhitespace() {
        return utils.TAB + utils.SPACE + utils.intToWhitespace(this.label);
    }
...
class IfNegative extends FlowControl {
    ...
    toSubWhitespace() {
        return utils.TAB + utils.TAB + utils.intToWhitespace(this.label);
    }
